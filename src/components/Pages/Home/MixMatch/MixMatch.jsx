        ...
        <div className="flex flex-col px-4 py-32 md:px-16 font-principal bg-pinkWhite lg:mt-32 mt-20">
            ...
            <Swiper className='flex justify-between w-full gap-16' slidesPerView={"auto"} autoplay={false} pagination={{clickable: true,}} navigation={true} modules={[Navigation, Autoplay]} >
                <SwiperSlide className="flex items-center justify-center px-4 md:px-0 md:grow md:basis-1/2 xl:basis-1/4">
                    <Link className='flex justify-center items-center grow lg:basis-1/4 transition-transform ease-in-out hover:scale-105' to="/mixmatch/1">
                        <img className="w-full md:w-2/3" src={mixMatchCool}></img>
                    </Link>
                </SwiperSlide>
                <SwiperSlide className="flex items-center justify-center px-4 md:px-0 md:grow md:basis-1/2 xl:basis-1/4">
                    <Link className='flex justify-center items-center grow lg:basis-1/4 lg:w-fit transition-transform ease-in-out hover:scale-105' to="/mixmatch/2">
                        <img className="w-full md:w-2/3" src={mixMatchPreppy}></img>
                    </Link>
                </SwiperSlide>
                <SwiperSlide className="flex items-center justify-center px-4 md:px-0 md:grow md:basis-1/2 xl:basis-1/4">
                    <Link className='flex justify-center items-center grow lg:basis-1/4 lg:w-fit transition-transform ease-in-out hover:scale-105' to="/mixmatch/3">
