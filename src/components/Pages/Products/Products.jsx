    ...
    return (
        <main className={`h-auto px-8 md:px-32 ${scrollPosition > 180 && "mt-32"}`}>
            <div className="relative flex flex-col items-center w-full my-16 md:flex-row gap-y-4">
                <h2 className="w-full md:w-fit text-4xl font-bold text-center md:-translate-x-1/2 md:absolute font-principal md:left-1/2">{category ? category.charAt(0).toUpperCase() + category.slice(1) : "Todos"}</h2>
