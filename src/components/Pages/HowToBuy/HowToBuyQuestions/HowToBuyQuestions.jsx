        ...
        <div className="flex flex-col text-center">
            ...
            <div className="flex flex-col md:flex-row justify-between px-16 gap-8">
                <div className="text-xl flex flex-col grow basis-1/5 gap-4">
                    ...
                    <p><span className="text-xl font-bold font-principal">Navegá</span> por las categorías y hacé click sobre el producto que te interese.</p>
                </div>
                ...
                <div className="text-xl flex flex-col grow basis-1/5 gap-4">
                    ...
                    <p><span className="text-xl font-bold font-principal">Elegí</span> el talle y el color de mayor preferencia. Si no conoces tu talle, podes utilizar nuestra guía de talles de referencia.</p>
                </div>
                <div className='flex items-center justify-center py-4'>
                    <img src={arrowRigth} className="rotate-90 md:rotate-0"/>
                </div>
